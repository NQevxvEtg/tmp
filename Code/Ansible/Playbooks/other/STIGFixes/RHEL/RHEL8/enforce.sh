...
export STIG_PATH="$STIG_HOME/roles/rhel8STIG/files/U_RHEL_8_STIG_V2R3_Manual-xccdf.xml"
...
REPORT_DIR="$STIG_HOME/reports/rhel8_stig_reports"
REPORT_FILENAME="rhel8_stig_report_$(date +%Y%m%d_%H%M%S).xml"
